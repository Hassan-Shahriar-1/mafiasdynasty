                ...
                <div class="container-fluid  no-gutters px-0 ">
                    <div class="card">
                        <div class="card-header p-0">
                            <div class="row Gp0m0 text-center blkgry py-2 d-flex justify-content-center"> <h4 class="subtitlefnt">Family Name:  {{clnmm}}</h4></div>
                        </div>
                        <div class="card-body p-1">
                            <div class="btn-group rounded jaldi bw100 mb-2 "  role="group" aria-label="..." >
                                <router-link to="gossipe" tag="a"  class="btn nBtn blkgry Gp0m0 "><i class="fas fa-comments"></i> <br> <h4 class="siz15">Gossip</h4></router-link>
                                <router-link to="family" tag="a"  class="btn nBtn blkgry Gp0m0 "><i class="fas fa-users"></i> <br><h4 class="siz15">Family</h4></router-link>
                                <router-link to="member" tag="a"  class="btn nBtn blkgry Gp0m0 "><i class="fas fa-users"></i> <br><h4 class="siz15">Members</h4></router-link>
                                <div tag="a"   class="btn nBtn blkgry Gp0m0" @click="lsow()" ><i class="fas fa-sign-out-alt"></i>  <br><h4 class="siz15">Leave</h4></div> 
                            </div>
                    ...
                    <modal v-if="org==true" name="leve" :width="350" :height="250" class="mblr">
                        <div class="mrgnbtm tmibg bdr3 p-2 bmsdo rounded overflow-y" style="height:250px; width:auto;">
                            ...
                            <div class=" row no-gutters rounded mt-5">
                                <div class="col-6 p-1"><div class="btn nBtn btn-block btn-lg btnbfnt blkredbtn" @click="leaveConfrm()">Yes</div></div>
                                <div class="col-6 p-1"><div class="btn nBtn btn-block btn-lg btnbfnt button5" @click="lhide()"> No</div></div>
                            </div>
                        </div>
                    </modal>  
                </div>
