    ...
    <div>
        <div class="card">
            ...
            <div class="card-body Gp2m2">
                <img src="../../assets/img/item/Gold-bar.png"  class="card-img rounded-0 blksdout" alt="" style="height:120px;">
                ...
                <div class="card p-1" v-for="(lst,i) in list" :key="i">
                    <div class="card-header  blkd75 p-2"><div class="col-12"><h4 class="text-center titlefntnew">{{lst[0]}}</h4></div></div>
                    <div class="card-body blkd50">
                        <div class="row Gp0m0">
                            ...
                            <div class="col-3 p-0">
                                ...
                                <img  src="../../assets/img/item/1.gif" class="card-img  vertical-center" alt="">
                            </div>
                            <div class="col-6"><h5 class="titlefnt2 siz17">Safe House for {{lst.drtm}} Hour Which will cost {{lst.csttp}}</h5>
                            ...
                            <div class="col-3 Gp0m0"><h6 class="dtlsfnt">Requirment</h6><h6 class="text-success dtlsfnt siz17">{{lst.cst}} {{lst.csttp}}</h6> <div class=" mt-1 btn nBbg nBtn  button5 btnfnt siz15 btn-block p-1" @click="active(i)">Activate</div></div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods:{
        active(key){
            this.$mgo.gt('/safehouse/'+key+'/active',(rs)=>{
                console.log(rs)
            })
