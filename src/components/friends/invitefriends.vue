/* Invite friends section consist a list to invite friends on a popup modal  */

<template>
  <div>
    <div class="row no-guttersb3px blkgry p-2 m-0 rounded">
      <div class="w-100">
        <h2 class="text-center py-2 w-100 text-golden subtitlefnt">
          Invite for Apps
        </h2>
        <br />
      </div>
