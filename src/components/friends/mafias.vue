<template>
    <div>
       <div class="row Gp0m0 mt-1 ">
            <div class="card-body p-1">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                            <span class="input-group-text Gp0m0" id="basic-addon2">  <button class="btn nBtn blkgry btn-block mr-1 " @click="tog ^= true"><i class="fas fa-search"></i></button></span>
                    </div> 
        ...
        <div>
            <h6 v-if="errmsg" class="text-white text-center w-100 jaldi">{{errmsg}}</h6>
            <div v-else class="row no-gutters py-1 ">
                <div class="col-6 Gp0m0 no-guttersb3px" v-for="(list,i) in frndlst" :key="i">
                    <div class="bdrblk2 tmibg rounded blksdo"  @click="show(list.uid)">
                        <div class="row py-2 no-gutters bdr1" >
                            <div class="col-3 "><img src="../../assets/img/1.png" class="card-img p-1" alt=""></div>
                            <div class="col-9 px-1">
                                <h5 class="text-widge-bold subtitlefnt siz15" style="word-break:break-all;">{{list.name}}</h5>
        ...
        <modal name="mdlfndsts" animation="slideDown" :width='300' :height='227'  :isAutoHeight="true"   @before-open="beforeOspen" class="mblr" >             
            <div class="row Gp0m0 tmibg  bdr3 p-3 blksdout rounded">
                <div class="col-12 Gp0m0"><router-link :to="{path:'/game/otrprofile/'+this.uid}"><div class="btn nBtn btn-lg text-center btnbfnt btn-block  sizv35 ">View</div></router-link></div>
                <div class="col-12 Gp0m0"> <div class="btn nBtn btn-lg text-center btnbfnt btn-block  sizv35 ">unfriend</div></div>
                <div class="col-12 Gp0m0">  <router-link :to="{path:'/game/chat/'+this.uid}"> <div class="btn nBtn btn-lg text-center btnbfnt btn-block  sizv35">Message</div></router-link></div>
