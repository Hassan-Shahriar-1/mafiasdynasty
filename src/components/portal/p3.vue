<template>
    <div>
        ...
        <div class="Gdftrt9bg">
            <div class="p-2" >					
                <div class="row m-0 p-2" v-for="(itm,i) in itmlst" :key="i">
                    <div class="col-3 Gp0m0">
                            <img class="card-img-top nC-pd6p " :src="require('/src/assets/img/item/'+itm.simg)">
                    </div>
                    <div class="col-9">
            ...
            <div class="text-center"> <button class="btn nBtn nBbg button4 btn-block" style="opacity:0.7;"> <h4>Locked <i class="fas fa-lock"></i></h4></button></div>
            </div>
        </div>
    </div>                   
</template>
