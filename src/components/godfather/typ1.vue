<template>
    <div class="bMbg3" >
        <div class="row py-2 text-center Gp0m0"><h4 class="hr-sect jaldi">Godfathers</h4></div>
        <div class="card Gp0m0">
                <div class="card-header blkgry text-center"><h4 class="titlefnt">Fredo Carlos</h4></div>
        ...
        <modal name='Gitmso' class="mblr bdr p-1 rounded-2" style="height:300px;"  :width='300'   :isAutoHeight="true"  @before-open="beforeOspen" >
            <div class="card Gp0m0" style="height:300px">
                ...
                <div class="card-body Gp0m0 tmibg">
                    <div class="row Gp0m0 mt-3">
                        <div class="col-6"><img class="card-img" :src="mdlitmimg" alt=""></div>
                        <div class="col-6 Gp0m0"><h3 class="subtitlefnt">You found item {{ mdlimnm }}.</h3></div>
                    </div>
                </div>
            </div>
        </modal> 
    ...
    methods:{
        ...
        itmgt(){
            this.$mgo.gt('elders/eld1/itm/get',(res)=>{
                ...
                if(res.sts=='itmgt'){
                        this.mdlimnm=res.data.name,
                        this.mdlitmimg=res.data.img
                }
            })
        },
        getingo(){
