<template>
    <div class="section rounded tmibg border p-2">
        ...
        <div class="container Gp0m0 " >
            <h3 class="w-100 dark50 text-center py-1"> Intellegence <i @click="intellegenceinfo ^= true" class="fas fa-question-circle float-right sizv35 p-2"></i></h3>
            ...
            <div class="row Gp0m0 w-100 mt-2">
                ...
                <div v-else ><div class=" m-1 border rounded"><img :src="link+inint.img" class="card-img" alt=""> <br> <h6 class="sizv13 blkred p-2 dtlsfnt">{{inint.name}}</h6></div>
                </div>
                </div>
...
<!-- 
              <div class="row Gp0m0 w-100 mt-2">
                ...
                <div class="col-6 tmibg bnrbxsdo " v-for="(inint, i) in ises" :key="i">
                    <div class="row Gp0m0"> 

                        <div class=" col-4 p-1 border rounded">
                            <img :src="require('../../assets/img/'+inint.mg)" class="card-img" alt="">
                        </div><br>
                        <div class="col-8 p-0"> <h6 class="sizv15 p-1 dtlsfnt">{{inint}}</h6></div>
                    </div>
            </div>
            </div> -->
...
export default {
    data() {
        return{
            ...
            intellegenceinfo:false,
            link:'http://mrdemo.com/intilligence/',                
            intilligence:[]
        }
        
    },
    beforeCreate(){
        this.$mgo.gt('intiligence/list',(rs)=>{
            if(rs.sts=='ok'){
