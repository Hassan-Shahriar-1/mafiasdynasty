    ...
    <div>
        ...
        <div class="row Gp0m0">
            <div class="col-4 Gp0m0 p-1" v-for="(aitm,i) in itm" :key='i'>
                <div class="card bg-transparent btn nBtn nBbg p-2 jaldi Gp0m0" @click="show(aitm.name,aitm.img,aitm.cst)">
        ...
        <modal name="vhcls"  :width='300'  :height='271' :isAutoHeight="true"   @before-open="beforeOspen" class="mblr">
                    ...
                    <div>
                        <h6 class="text-white">cost:{{ mcst*amnt}}</h6>
                            ...
                            <div class="col-12 Gp0m0 pr-1"><div class="btn nBtn btn-lg text-center btnbfnt btn-block button5 sizv35" @click="hide()">Buy Now</div></div>
                    </div> 
        </modal> 
   </div>
